...
describe('format', () => {
  ...
  test('should format with different precision', () => {
    ...
    expect(format(1.01, 3)).toBe('1,010');
    expect(format(1.001, 3)).toBe('1,001');
    expect(format(10.001, 3)).toBe('10,001');
    expect(format(100.001, 3)).toBe('100,001');
    expect(format(1000.001, 3)).toBe('1.000,001');
    expect(format(10000.001, 3)).toBe('10.000,001');
    expect(format(100000.001, 3)).toBe('100.000,001');
    expect(format(1000000.001, 3)).toBe('1.000.000,001');
  });
});
